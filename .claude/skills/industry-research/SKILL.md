---
description: "AI Berkshire 项目内工作流：行业投资研究：产业链全景扫描 + 四大师个股分析框架"
...
基于投资逻辑链的确定性和风险程度，形成主题仓位、买卖信号与 ETF 替代的研究判断；最终呈现由模板负责。

## 第八步：渲染行业研究报告

生成前读取 [.claude/rules/report-output.md](../../rules/report-output.md) 及其指定模板。最终报告的产业链图、全球扫描、机会评估、组合建议、行业总评和占位符严格以模板为准；本 Skill 只保留逻辑链验证、产业链拆解、公司分析、风险与反偏见流程。

## 输出要求

1. 所有分析必须有数据支撑，附数据来源
2. 每个环节至少分析 2-3 家头部公司
3. 全球公司扫描要尽可能完整（A 股/港股/美股/国际）
4. 每个分析模块末尾有对应大师的“追问”
