---
description: "AI Berkshire 项目内工作流：巴菲特价值投资买入前 Checklist"
...
生成前读取 [.claude/rules/report-output.md](../../rules/report-output.md) 及其指定模板。单公司六关评分、多公司总览对比表与最终呈现严格以模板为准；本 Skill 只保留六关判定、镜子测试与红线否决规则。
