---
description: "AI Berkshire 项目内工作流：管理层纵深研究：买股票就是买人"
...
生成前读取 [.claude/rules/report-output.md](../../rules/report-output.md) 及其指定模板。最终报告的章节、评分表、管理层结论与占位符严格以模板为准；本 Skill 只保留关键人物识别、预测回测、诚信/资本配置/治理取证与“买人”判断规则。
