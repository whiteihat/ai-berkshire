---
description: "AI Berkshire 项目内工作流：组合管理：从"研究公司"到"管理组合""
...
生成前读取 [.claude/rules/report-output.md](../../rules/report-output.md) 及其指定模板。最终报告的章节、持仓表、组合分析、调仓建议和占位符严格以模板为准；本 Skill 只保留持仓解析、估值校验、相关性判断、机会成本计算、压力测试与调仓逻辑。
