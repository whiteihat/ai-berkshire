---
description: "AI Berkshire 项目内工作流：去劣筛选：7条指标快速排除非一流公司"
...
生成前读取 [.claude/rules/report-output.md](../../rules/report-output.md) 及其指定模板。单公司 7 条指标逐条检验、批量汇总、板块总结与结论的读者可见结构严格以模板为准；本 Skill 只保留指标阈值、豁免规则与数据不足处理规则。
...
- 输出路径与文件命名以 [.claude/rules/report-output.md](../../rules/report-output.md) 路由表为准。
