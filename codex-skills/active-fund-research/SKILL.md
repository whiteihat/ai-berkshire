---
name: active-fund-research
description: "AI Berkshire skill: 主动基金研究：买基金就是买基金经理. Source: skills/active-fund-research.md."
---

## Codex adapter note

This skill is generated from `skills/active-fund-research.md` so Claude Code and Codex users share one canonical workflow.
...
4. 报告写入 `reports/{基金名}-activefund-{YYYYMMDD}.md`（reports/ 根目录）
