---
name: index-fund-research
description: "AI Berkshire skill: 被动指数基金研究：买指数就是买商业模式集合. Source: skills/index-fund-research.md."
---

## Codex adapter note

This skill is generated from `skills/index-fund-research.md` so Claude Code and Codex users share one canonical workflow.
...
4. 报告写入 `reports/{基金名}-indexfund-{YYYYMMDD}.md`（reports/ 根目录）
