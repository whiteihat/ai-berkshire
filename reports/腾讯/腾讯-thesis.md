...
| 2026-08-13 | Q2电话会精读 | 全年资本开支拒给数字，给三条框架（今明两年一次性/回报不及预期封顶/新增开支与收益挂钩）；回购首次明示为资本开支让位；云增速高十位数→20%出头，年底加大GPU出租；AI新产品拖累88亿→105亿；ADR绩后-5.4% | 假设6再降级：按前瞻口径2026年股东回报率大概率回不到50%，按"已失效、待年报确认"对待；假设5⬆️（云变现路径变清晰）；元宝连续两季无数据，观察对象切换为小微+WorkBuddy | 无红线触发 | 持有；Q3财报升级为论文校准点（三硬指标：AI拖累是否稳在105亿量级/云增速续升/回购节奏）；跌破455港元按纪律是加仓评估区（详见腾讯-earnings-2026Q2-电话会精读-20260813.md） |
| | | | | | |
| | | | | | |
